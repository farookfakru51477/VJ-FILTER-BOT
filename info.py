...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ImdbTV:imdbtvbot@cluster0.w2vy4dw.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "ImdbTV")
